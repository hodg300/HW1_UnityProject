...
public class Motion : MonoBehaviour
{
    ...
    public GameObject playerCamera; //Public allow to init this object from Unity!!
    ...
    void Update()
    {
        ...
        transform.localEulerAngles = new Vector3(0, ry, 0); // Only Horizontal view - run only this (Player)
        // keyboard input
